...
Simplifies the interface for os/exec on Linux systems.

Handles all of the necessary type conversions to completely inspect both
the syscall.WaitStatus result and the syscall.Rusage resource usage
information.

Includes a python subprocess like ‘communicate‘ function.
...
I have no idea what I’m doing, so this is probably all wrong.
